...
export function SecurityPage() {
  ...
  const mfaMut = useMutation({ 
    mutationFn: (en: boolean) => toggleMFA(en), 
  ...
  return (
    // Increased max width to 5xl to accommodate the grid layout
    <PageShell title="Security" subtitle="Manage account security settings." maxWidth="max-w-5xl">
      
      {/* CSS Grid with items-start prevents cards from stretching vertically */}
